...
class Row40 extends React.Component {
  ...
  render() {
    const onSelect = (index, selected) => {
      this.props.onSelect(index, selected);
    };

    const rowValue = this.props.rowValue;
    const height = this.props.big ? 20 : 15;
    ...
    return (
      <View style={styles.row}>
        ...
        <Cell
          value={rowValue[10]} height={height} onSelect={(selected) => onSelect(10, selected)}
        />
        <Cell
          value={rowValue[11]} height={height} onSelect={(selected) => onSelect(11, selected)}
        />
        <Cell
          value={rowValue[12]} height={height} onSelect={(selected) => onSelect(12, selected)}
        />
        <Cell
          value={rowValue[13]} height={height} onSelect={(selected) => onSelect(13, selected)}
        />
        <Cell
          value={rowValue[14]} height={height} onSelect={(selected) => onSelect(14, selected)}
        />
        <Cell
          value={rowValue[15]} height={height} onSelect={(selected) => onSelect(15, selected)}
        />
        <Cell
          value={rowValue[16]} height={height} onSelect={(selected) => onSelect(16, selected)}
        />
        <Cell
          value={rowValue[17]} height={height} onSelect={(selected) => onSelect(17, selected)}
        />
        <Cell
          value={rowValue[18]} height={height} onSelect={(selected) => onSelect(18, selected)}
        />
        <Cell
          value={rowValue[19]} height={height} onSelect={(selected) => onSelect(19, selected)}
        />
        <Cell
          value={rowValue[20]} height={height} onSelect={(selected) => onSelect(20, selected)}
        />
        <Cell
          value={rowValue[21]} height={height} onSelect={(selected) => onSelect(21, selected)}
        />
        <Cell
          value={rowValue[22]} height={height} onSelect={(selected) => onSelect(22, selected)}
        />
        <Cell
          value={rowValue[23]} height={height} onSelect={(selected) => onSelect(23, selected)}
        />
        <Cell
          value={rowValue[24]} height={height} onSelect={(selected) => onSelect(24, selected)}
        />
        <Cell
          value={rowValue[25]} height={height} onSelect={(selected) => onSelect(25, selected)}
        />
        <Cell
          value={rowValue[26]} height={height} onSelect={(selected) => onSelect(26, selected)}
        />
        <Cell
          value={rowValue[27]} height={height} onSelect={(selected) => onSelect(27, selected)}
        />
        <Cell
          value={rowValue[28]} height={height} onSelect={(selected) => onSelect(28, selected)}
        />
        <Cell
